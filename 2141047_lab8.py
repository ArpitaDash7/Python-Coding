...
def Insert_Data():
    ...
    try:
        ...
        file_path = os.path.join(desktop_path, "Registration_Information.txt")
        ...
        messagebox.showerror("Error", "An error occurred. Please check console output.")
...
exit_button = ttk.Button(text='Exit', command=quit_win)  # Renamed the button to exit_button
exit_button.grid(row=7, column=1, columnspan=2, sticky=W + E, padx=(2, 15), pady=(0, 15), ipadx=3, ipady=3)


# Add a Image

desktop_path = os.path.expanduser("~/Desktop")  # Get the user's desktop path
image_file_name = "AB2.png"
file_path = os.path.join(desktop_path, image_file_name)
